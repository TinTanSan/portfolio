...
export default function ProjectCard({projectDetails, id}:props) {
  ...
  return (
    <div id={id} className='grid row-span-1 h-[70vh] col-span-1 grid-flow-row-dense grid-rows-9 grid-cols-1 bg-base-100  border-2 border-base-300 text-base-content shadow-xl/30 shadow-zinc-500 rounded-lg gap-5 p-2 py-4 zoom-in-div'>
        ...
        <div className='grid row-span-8 grid-rows-6 w-full h-full'>
            ...
            <div className='grid grid-flow-col-dense grid-cols-1 grid-rows-2 gap-1 w-full justify-between'>
              ...
              <div className='grid row-span-1 col-span-1 items-center'>
                <Link href={"/projects/"+projectDetails.projectURL} className='bg-neutral hover:bg-neutral-hover text-neutral-content px-2 rounded-lg flex items-center justify-center text-nowrap w-full h-10'>
                  Read more
                </Link>
              </div>
            </div>
